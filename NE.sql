...
--
-- Creating the table structure for the table `NE_events`
--

DROP TABLE IF EXISTS `NE_events`;
...
--
-- Insert record data for the table `NE_events`
--

INSERT INTO `NE_events` (`eventID`, `eventTitle`, `eventDescription`, `venueID`, `catID`, `eventStartDate`, `eventEndDate`, `eventPrice`) VALUES
...
--
-- Creating the table structure for the table `NE_venue`
--

DROP TABLE IF EXISTS `NE_venue`;
CREATE TABLE IF NOT EXISTS `NE_venue` (
...
--
-- Insert record data for the table `NE_venue`
--

INSERT INTO `NE_venue` (`venueID`, `venueName`, `location`) VALUES
...
--
-- Creating the table structure for table `NE_users`
--

DROP TABLE IF EXISTS `NE_users`;
...
--
-- Inserting data for table `NE_users`
--

INSERT INTO `NE_users` (`userID`, `firstname`, `surname`, `username`, `passwordHash`) VALUES
